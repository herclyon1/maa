...
|---|---|
| **One page per game** | Five tabs 状态 / 方舟 / 终末地 / 鸣潮 / 手机 (`layoutTabs`; HIG: at most five on iPhone, weekly rows live in their game's tab) in a floating glass tab bar at the bottom (iOS 26/27 Liquid Glass: translucent capsule, blur, specular edge); one tab visible at a time; the last tab is remembered. Nothing is ever added outside a tab |
