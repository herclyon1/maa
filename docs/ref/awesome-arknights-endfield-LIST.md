> **Upstream text, reproduced verbatim — not translated.** This is a local snapshot of
> the list generated by [palmcivet/awesome-arknights-endfield](https://github.com/palmcivet/awesome-arknights-endfield).
> Every project name and description below is the upstream author's own wording. Do not
> translate or reword it: it has to stay diffable against upstream.
