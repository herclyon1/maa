...
echo "▶ 2/20 不许用 powershell 5.1（要用 pwsh 7）"
...
echo "▶ 3/20 ssh 送 PowerShell 必须走 base64"
...
echo "▶ 9/20 静态检查（pyflakes + 3.14 严格编译）"
...
echo "▶ 15/20 文档自检（check-docs --local）"
...
echo "▶ 18/20 指向 CODE-HISTORY 的锚点要唯一、上面那句话要说完"
...
echo "▶ 19/20 ruff（让那些 noqa 真的有人验）"
