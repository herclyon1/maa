...
/* 演示用的母本（仅 ?demo / ?accept 且没配信箱时）。结构与真快照一致：master[game] = {values, options, labels, readonly}；
   ...
   ProtocolSpace/* 那 15 项是 read_maaend 对着 relay/tests/fixtures/maaend-protocolspace-v2.30.0-rc.1 和 test_mastercfg_protocolspace.py 的母本读出（WeaponTune 的 A/B 母本里没有 = null）。 */
const DEMO_MASTER = {"MAA":{"values":{"Infrast/UsesOfDrones":"Money","Award/Mail":true,"Award/Orundum":false,"Award/Mining":true,"Award/SpecialAccess":false},"options":{"Infrast/UsesOfDrones":[["贸易站 · 龙门币","Money"],["贸易站 · 合成玉","SyntheticJade"],["制造站 · 作战记录","CombatRecord"],["制造站 · 赤金","PureGold"],["制造站 · 源石碎片","OriginStone"],["制造站 · 芯片","Chip"]]},"labels":{"Infrast/UsesOfDrones":"基建无人机用在哪","Award/Mail":"领取所有邮件奖励","Award/Orundum":"领取幸运墙的每日合成玉奖励","Award/Mining":"领取限时开采许可的每日合成玉奖励","Award/SpecialAccess":"领取周年赠送月卡奖励"}},"MaaEnd":{"values":{"AutoEssence/@enabled":true,"AutoEssence/AutoEssenceDoOverride":false,"AutoEssence/AutoEssenceObtainMode":"ObtainScaling2","AutoEssence/AutoEssenceRepeatCount":"6","AutoEssence/AutoEssenceChooseLocation":["WLSwordVaultDale","WLQingboStockade"],"AutoEssence/EssenceFilterAfterBattle":true,"AutoEssence/AutoUseSpMedication":"EndTask","AutoEssence/AutoEssenceSpMedicationExpireWithinDays":"Days3","AutoCollect/@enabled":true,"AutoCollect/AutoCollectSchedule":["AutoCollectScheduleMonday","AutoCollectScheduleWednesday","AutoCollectScheduleFriday"],"ProtocolSpace/@enabled":false,"ProtocolSpace/ProtocolSpaceSchedule":["ProtocolSpaceScheduleMonday","ProtocolSpaceScheduleTuesday","ProtocolSpaceScheduleWednesday","ProtocolSpaceScheduleThursday","ProtocolSpaceScheduleFriday","ProtocolSpaceScheduleSaturday","ProtocolSpaceScheduleSunday"],"ProtocolSpace/ProtocolSpaceMode":"ByCount","ProtocolSpace/ProtocolSpaceTab":"OperatorProgression","ProtocolSpace/OperatorProgression":"OperatorEXP","ProtocolSpace/WeaponProgression":"WeaponEXP","ProtocolSpace/CrisisDrills":"AdvancedProgression1","ProtocolSpace/ProtocolSpaceLevel":"ProtocolSpaceLevel05","ProtocolSpace/OperatorEXPRewardsSetOption":"CognitiveCarriers","ProtocolSpace/PromotionsRewardsSetOption":"Protoset","ProtocolSpace/SkillUpRewardsSetOption":"Protohedron","ProtocolSpace/WeaponTuneRewardsSetOption":null,"ProtocolSpace/ProtocolSpaceObtainMode":"ObtainScaling2","ProtocolSpace/ProtocolSpaceSuccessCount":"ProtocolSpaceSuccessCountUnlimited","ProtocolSpace/ProtocolSpaceUseSpMedication":"UseMedication"},"options":{"AutoEssence/AutoEssenceObtainMode":[["不领取（仅刷素材）","Discard"],["单倍领取","ObtainScaling1"],["双倍领取","ObtainScaling2"]],"AutoEssence/AutoEssenceChooseLocation":[["枢纽区","VFTheHub"],["源石研究园","VFOriginiumSciencePark"],["矿脉源区","VFOriginLodespring"],["供能高地","VFPowerPlateau"],["武陵城区","WLWulingCity"],["清波寨","WLQingboStockade"],["首墩","WLMarkerStone"],["试验园区","WLTestArea"],["藏剑谷","WLSwordVaultDale"],["应龙关","WLYinglungPass"],["北部禁区","WLNorthWulingExclusionZone"],["雪松林","WLSnowyForest"]],"AutoEssence/AutoUseSpMedication":[["结束任务","EndTask"],["使用药剂恢复","UseMedication"]],"AutoEssence/AutoEssenceSpMedicationExpireWithinDays":[["全部","All"],["10天内","Days10"],["7天内","Days7"],["3天内","Days3"],["1天内","Days1"]],"AutoCollect/AutoCollectSchedule":[["周一","AutoCollectScheduleMonday"],["周二","AutoCollectScheduleTuesday"],["周三","AutoCollectScheduleWednesday"],["周四","AutoCollectScheduleThursday"],["周五","AutoCollectScheduleFriday"],["周六","AutoCollectScheduleSaturday"],["周日","AutoCollectScheduleSunday"]],"ProtocolSpace/ProtocolSpaceSchedule":[["周一","ProtocolSpaceScheduleMonday"],["周二","ProtocolSpaceScheduleTuesday"],["周三","ProtocolSpaceScheduleWednesday"],["周四","ProtocolSpaceScheduleThursday"],["周五","ProtocolSpaceScheduleFriday"],["周六","ProtocolSpaceScheduleSaturday"],["周日","ProtocolSpaceScheduleSunday"]],"ProtocolSpace/ProtocolSpaceMode":[["按次数刷取","ByCount"],["目标库存","TargetInventory"]],"ProtocolSpace/ProtocolSpaceTab":[["干员养成","OperatorProgression"],["武器养成","WeaponProgression"],["危境预演","CrisisDrills"]],"ProtocolSpace/OperatorProgression":[["干员经验","OperatorEXP"],["干员进阶","Promotions"],["钱币收集（折金票）","T-Creds"],["技能提升","SkillUp"]],"ProtocolSpace/WeaponProgression":[["武器经验（武器检查套组、武器检查装置）","WeaponEXP"],["武器进阶","WeaponTune"]],"ProtocolSpace/CrisisDrills":[["高阶培养Ⅰ（D96钢样品四）","AdvancedProgression1"],["高阶培养Ⅱ（超距辉映管）","AdvancedProgression2"],["高阶培养Ⅲ（快子遴捡晶格）","AdvancedProgression3"],["高阶培养Ⅳ（象限拟合液）","AdvancedProgression4"],["高阶培养Ⅴ（三相纳米片）","AdvancedProgression5"]],"ProtocolSpace/ProtocolSpaceLevel":[["一级","ProtocolSpaceLevel01"],["二级","ProtocolSpaceLevel02"],["三级","ProtocolSpaceLevel03"],["四级","ProtocolSpaceLevel04"],["五级","ProtocolSpaceLevel05"]],"ProtocolSpace/OperatorEXPRewardsSetOption":[["B.高级作战记录","AdvancedCombatRecord"],["A.高级认知载体、初级认知载体","CognitiveCarriers"]],"ProtocolSpace/PromotionsRewardsSetOption":[["B.协议圆盘","Protodisk"],["A.协议圆盘组","Protoset"]],"ProtocolSpace/SkillUpRewardsSetOption":[["B.协议棱柱","Protoprism"],["A.协议棱柱组","Protohedron"]],"ProtocolSpace/WeaponTuneRewardsSetOption":[["B.强固模具","CastDie"],["A.重型强固模具","HeavyCastDie"]],"ProtocolSpace/ProtocolSpaceObtainMode":[["双倍领取","ObtainScaling2"],["单倍领取","ObtainScaling1"],["不领取","Discard"]],"ProtocolSpace/ProtocolSpaceSuccessCount":[["1","ProtocolSpaceSuccessCount1"],["2","ProtocolSpaceSuccessCount2"],["3","ProtocolSpaceSuccessCount3"],["4","ProtocolSpaceSuccessCount4"],["5","ProtocolSpaceSuccessCount5"],["无限制","ProtocolSpaceSuccessCountUnlimited"]],"ProtocolSpace/ProtocolSpaceUseSpMedication":[["结束任务","EndTask"],["使用药剂恢复","UseMedication"]]},"labels":{"AutoEssence/@enabled":"🎱基质刷取","AutoEssence/AutoEssenceDoOverride":"使用刻写券","AutoEssence/AutoEssenceObtainMode":"领取方式","AutoEssence/AutoEssenceRepeatCount":"循环执行","AutoEssence/AutoEssenceChooseLocation":"随机地区","AutoEssence/EssenceFilterAfterBattle":"战后基质筛选","AutoEssence/AutoUseSpMedication":"理智不足时","AutoEssence/AutoEssenceSpMedicationExpireWithinDays":"使用几天内","AutoCollect/@enabled":"🧺自动采集","AutoCollect/AutoCollectSchedule":"执行周期(游戏时间)","ProtocolSpace/@enabled":"⚔️协议空间","ProtocolSpace/ProtocolSpaceSchedule":"执行周期(游戏时间)","ProtocolSpace/ProtocolSpaceMode":"刷取模式","ProtocolSpace/ProtocolSpaceTab":"协议空间","ProtocolSpace/OperatorProgression":"干员养成","ProtocolSpace/WeaponProgression":"武器养成","ProtocolSpace/CrisisDrills":"危境预演","ProtocolSpace/ProtocolSpaceLevel":"选择协议空间等级","ProtocolSpace/OperatorEXPRewardsSetOption":"可选奖励组","ProtocolSpace/PromotionsRewardsSetOption":"可选奖励组","ProtocolSpace/SkillUpRewardsSetOption":"可选奖励组","ProtocolSpace/WeaponTuneRewardsSetOption":"可选奖励组","ProtocolSpace/ProtocolSpaceObtainMode":"领取方式","ProtocolSpace/ProtocolSpaceSuccessCount":"行动成功次数上限","ProtocolSpace/ProtocolSpaceUseSpMedication":"理智不足时"}},"OK-WW":{"values":{"DailyTask.json/Which to Farm":"Tacet Suppression","DailyTask.json/Material Selection":"Shell Credit","DailyTask.json/Which Forgery Challenge to Farm":3,"DailyTask.json/Which Tacet Suppression to Farm":2},"options":{"DailyTask.json/Which to Farm":[["凝素领域","Forgery Challenge"],["无音区","Tacet Suppression"],["模拟领域","Simulation Challenge"]],"DailyTask.json/Material Selection":[["Resonator EXP","Resonator EXP"],["Weapon EXP","Weapon EXP"],["Shell Credit","Shell Credit"]]},"labels":{},"readonly":{"NightmareNestTask.json/Only Farm These Nests":"落渊南丘"}}};
