...
(function () {
  ...
  window.ACCEPT.files = ["page","tile","segctl","alert-view","tabbar-view","topbar-view","cell","motion","nav","nav-edge","sheet","menu","topbar","refresh","glassbtn","alert","switch","tabbar","diagmark","stockpile"]; window.ACCEPT.loaded = new Set();   // 2026-09-20 split: page / tile / segctl / alert-view / tabbar-view / topbar-view / cell hold what were accept.js's own sections (run first: the static rows measure the untouched page)
